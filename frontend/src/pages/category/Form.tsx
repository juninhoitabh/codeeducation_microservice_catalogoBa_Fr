import { Box, Button, ButtonProps, Checkbox, TextField, makeStyles, Theme } from '@material-ui/core';
...
export const Form = () => {
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)}>
			...
			<TextField name='description' label='Descrição' multiline rows='4' fullWidth variant={'outlined'} margin={'normal'} inputRef={register} />
